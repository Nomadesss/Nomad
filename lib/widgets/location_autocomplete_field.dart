...
class LocationAutocompleteField extends StatefulWidget {
  ...
  final void Function(PlacePrediction prediction, PlaceDetail? detail)
  onSelected;
...
class _LocationAutocompleteFieldState extends State<LocationAutocompleteField> {
        ...
        child: Material(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: const Color(0xFF0D9488).withOpacity(.3),
              ),
  ...
  Widget build(BuildContext context) {
    return CompositedTransformTarget(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: widget.dark ? Colors.white.withOpacity(.05) : Colors.white,
